...
```{r}
library(rio)
data4 <- import("https://raw.githubusercontent.com/naswa/MPDW/main/Pertemuan%202/Californa_Wine_Production_2018-2020.csv")
Tahun = data4$Year
Panen = data4$Harvested
Produksi = data4$Production
Harga = data4$Price
Data4 = data.frame(Tahun,Panen,Produksi,Harga)
```
...
data.ts1<-ts(Data4$Panen)
data.ts1
data.ts2<-ts(Data4$Produksi)
data.ts2
data.ts3<-ts(Data4$Harga)
data.ts3

#Membuat plot time series
ts.plot(data.ts1, xlab="Tahun ", ylab="Panen", main= "Time Series Plot of Panen")
points(data.ts1)
ts.plot(data.ts2, xlab="Tahun ", ylab="Produksi", main= "Time Series Plot of Produksi")
points(data.ts2)
ts.plot(data.ts3, xlab="Tahun ", ylab="Harga", main= "Time Series Plot of Harga")
points(data.ts3)
```
